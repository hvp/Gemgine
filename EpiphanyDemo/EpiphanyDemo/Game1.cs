...
using Epiphany;
using Epiphany.Render;

namespace EpiphanyDemo
{
    /// <summary>
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            quad.Orientation.EulerOrientation.Z +=
                MathHelper.ToRadians((float)(gameTime.ElapsedGameTime.TotalSeconds * 90));
