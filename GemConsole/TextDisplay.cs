...
namespace Gem.Console
{
    public class TextDisplay
    {
        ...
        public void SetChar(int place, int character, Color? fg = null, Color? bg = null)
        {
            ...
            lines[row].verts[place * 4 + 0].TextureCoordinate = new Vector2(charX * fontXScale, charY * fontYScale);
            lines[row].verts[place * 4 + 1].TextureCoordinate = new Vector2((charX + 1) * fontXScale, charY * fontYScale);
            lines[row].verts[place * 4 + 2].TextureCoordinate = new Vector2((charX + 1) * fontXScale, (charY + 1) * fontYScale);
            lines[row].verts[place * 4 + 3].TextureCoordinate = new Vector2(charX * fontXScale, (charY + 1) * fontYScale);
